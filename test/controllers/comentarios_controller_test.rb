...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post comentarios_url, params: { comentario: { contenido: @comentario.contenido, tarea_id: @comentario.tarea_id, usuario_id: @comentario.usuario_id } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { contenido: @comentario.contenido, tarea_id: @comentario.tarea_id, usuario_id: @comentario.usuario_id } }
